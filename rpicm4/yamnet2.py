...
urlThingsBoard = 'http://DESKTOP-KD82ADA.local:8088/api/v1/sbwz8c7tyhxl5xe4j0sg/telemetry'
score = 0
cpuTemperature = 0
soundPresuredB = 0
...
def handle_touch(channel):
    ...
    global touchData
    touched = True
    touchData = mpr121.readWordData(mpr121.MPR121_ADDRESS )
    # print("kbd touched")
...
def display_string(message, line):
    display.lcd_display_string("{:<20}".format(message[:20]), line)
...
def process_file(wav_file_name, maximum) :
    ...
    display_string(infered_class, 3)
    classDetected = infered_class
    score = round(scores_np.mean(axis=0).max()*100.0,2)
    display_string("SCORE :{:.2f}  {:3}dB".format(score, int(maximum)),1)
    

def showTemp(temp):
    display.lcd_display_string("{0}  T: {1:.02f} C".format(strftime("%H:%M:%S"),temp), 4)
...
# Graphic Progressbar setup
custom = LCD.CustomCharacters(display)
# horizontal progress bar
custom.char_1_data = ["11111","00000","00000","00000","00000","00000","00000","11111"]
custom.char_2_data = ["11111","00000","10000","10000","10000","10000","00000","11111"]
custom.char_3_data = ["11111","00000","11000","11000","11000","11000","00000","11111"]
custom.char_4_data = ["11111","00000","11100","11100","11100","11100","00000","11111"]
custom.char_5_data = ["11111","00000","11110","11110","11110","11110","00000","11111"]
custom.char_6_data = ["11111","00000","11111","11111","11111","11111","00000","11111"]
custom.load_custom_characters_data()
# display.lcd_clear_display()


display_string("Loading model...",1)
print("Loading model")  
        ...
        if touched:
            ...
            for i in range(12):
                if (touchData & (1<<i)):
                    ...
                    display_string("Touched key [{0:2}]".format(str(touchedKey)),1)
                    #break
            touched = False
